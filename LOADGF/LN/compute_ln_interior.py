...
import numpy as np
from LOADGF.LN import compute_love_numbers_skeleton 

def main(radius_for_evaluation, num_soln = 100, stopn=100):
	...
	if (rank == 0):
		...
		compute_love_numbers_skeleton.main(planet_model,rank,comm,size,file_out=file_ext,stopn=stopn,eval_radius=radius_for_evaluation,num_soln=num_soln)#,interp_emod=True)
	...
	return ln_n,ln_h,ln_nl,ln_nk,ln_hpot,ln_nlpot,ln_nkpot
